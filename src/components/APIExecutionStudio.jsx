  ...
  return (
    <div className="flex-1 flex flex-col bg-probestack-bg min-h-0 overflow-hidden">
      <div className="flex-1 flex flex-col min-h-0 min-w-0">
        {/* Tab bar */}
        <div className="flex items-center border-b border-dark-600 bg-[#161B30] flex-shrink-0 min-h-0 overflow-hidden">
          {!hideNewButton && (
            <button
              type="button"
              onClick={onNewTab}
              className="flex items-center justify-center gap-1.5 px-3 h-11 shrink-0 text-gray-400 hover:text-primary hover:bg-primary/10 border-r border-dark-600 transition-colors text-xs font-semibold tracking-wide"
              title="New request"
            >
            ...
            {requests.map((req, index) => {
              ...
              return (
                <div
                  ...
                  className={clsx(
                    'flex items-center gap-2 pl-3 pr-1 py-2.5 min-w-0 max-w-[200px] shrink-0 border-r border-dark-600 cursor-pointer transition-colors group',
                    isActive
        ...
        {isWorkspaceDetails ? (
          ...
          <>
            ...
            <div className="px-5 py-4 bg-dark-800/50 border-b border-dark-600 flex-shrink-0">
            ...
            <div className="border-b border-dark-600 px-5 flex items-center justify-between flex-shrink-0 bg-[#161B30] gap-2 min-h-0">
