...
export default function ResponsePanel({ response, isLoading, error }) {
    if (isLoading) {
        return (
            <div className="flex-1 flex items-center justify-center text-dark-500 bg-dark-900">
    ...
    if (!response) {
        return (
            <div className="flex-1 flex flex-col items-center justify-center text-dark-600 bg-dark-900 select-none">
    ...
    return (
        <div className="flex-1 flex flex-col min-h-0 bg-dark-900 z-10 relative">
            {/* Response Header Bar */}
            ...
            {/* Response Body */}
            <div className="flex-1 overflow-auto custom-scrollbar relative bg-dark-900">
                <div className="p-6">
