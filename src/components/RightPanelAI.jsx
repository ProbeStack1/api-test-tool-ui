...
export default function RightPanelAI({
  ...
  return (
    <div className="w-80 min-w-[18rem] max-w-[20rem] border-l border-dark-700 bg-dark-800/90 flex flex-col h-full">
      {/* Fixed Header */}
      <div className="p-4 border-b border-dark-700 shrink-0">
        ...
        <p className="text-xs text-gray-500 py-1.5">Analyze and improve your API requests</p>
          ...
          <span className="px-2 py-1 rounded-full bg-dark-700 text-gray-300 truncate max-w-[200px]">
      ...
      {/* Fixed Tabs */}
      <div className="flex border-b border-dark-700 px-2 py-1.5 gap-1 shrink-0">
        {[
      ...
      {/* Scrollable Content Area (analysis + chat history) */}
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-4">
            ...
            {activeTab === 'analysis' && (
              <div className="space-y-3">
                <div className=" rounded-md p-3 border border-dark-700">
                  <p className="text-sm text-gray-300">{aiResponse.overview}</p>
                </div>
                <div>
        ...
        {/* Chat History (now inside scrollable area) */}
      ...
      <div className="border-t border-dark-700 p-3 shrink-0">
        <div className="flex gap-2">
          ...
          <button
            ...
            className="p-2 rounded-md bg-primary hover:bg-primary/90 text-white disabled:opacity-50"
          >
