      ...
      <div className="flex h-full flex-col">
        ...
        <div className="border-t border-border bg-surface/40 p-3" data-testid="ai-testing-active-suite-pin">
          ...
          {/* {activeSuite ? (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="truncate text-xs font-medium">{activeSuite.name}</div>
            ...
            <div className="rounded-md border border-dashed border-border bg-surface/30 px-2 py-3 text-center text-[10px] text-text-muted"
          ...
          <button
            ...
            className={cn(
              'mt-2 flex w-full items-center justify-between gap-2 rounded-md border px-2 py-2 text-left transition-colors',
              view === 'keys'
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-[11px] font-semibold">API keys</div>
                <div className="text-[9px] text-text-muted">OpenAI · Anthropic · Google · …</div>
              </div>
            </div>
...
const TokenBudgetBadge = ({ tu }: { tu: TokenUsageRollup | null }) => {
  ...
  return (
    <span className="relative inline-block"
      ...
      <span className="inline-flex cursor-help items-center gap-1 rounded-full border border-primary/40 bg-primary-muted px-1.5 py-0.5 text-[10px] font-semibold text-primary">
      ...
      {open && (
        <div className="absolute left-0 top-full z-50 mt-1.5 w-72 rounded-md border border-border bg-surface p-3 shadow-xl"
          ...
          <div className="mb-2 flex items-center justify-between">
            <span className="text-xs font-semibold text-text-primary">Token usage · last {tu.windowDays}d</span>
            <span className="font-mono text-[10px] text-text-muted">{tu.totalRuns} runs</span>
          </div>
...
const Mini = ({ label, value }: { label: string; value: string }) => (
  <div className="rounded-md border border-border/60 bg-elevated/40 px-2 py-1.5">
    ...
    <div className="font-mono text-[11px] font-semibold tabular-nums text-text-primary">{value}</div>
  </div>
);
