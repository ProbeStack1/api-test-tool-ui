      ...
      <div className="flex h-full flex-col">
        ...
        <div className="space-y-1 p-3">
          <div className="rounded-lg border border-primary/40 bg-primary-muted/40 p-3">
            ...
            <p className="mt-1 text-[12px] text-text-secondary">Inspect · orchestrate · mock · bridge</p>
      ...
      >
        ...
        <div className="border-t border-border bg-surface/40 p-3" data-testid="mcp-active-server-pin">
          <div className="mb-1.5 flex items-center justify-between">
            <span className="text-xs font-semibold uppercase tracking-wide text-text-muted">Active server</span>
            {activeServer && (
          ...
          {isLoading ? (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="truncate text-sm font-medium">{activeServer.name}</div>
                <div className="truncate font-mono text-xs text-text-muted">{activeServer.serverUrl}</div>
            ...
            <div className="rounded-md border border-dashed border-border bg-surface/30 px-2 py-3 text-center text-xs text-text-muted" data-testid="mcp-active-server-empty">
