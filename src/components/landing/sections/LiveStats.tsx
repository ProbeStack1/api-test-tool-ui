...
function StatItem({ icon: Icon, label, end, suffix, decimals = 0, prefix = '', isVisible, delay }) {
  ...
  return (
    ...
    >
      <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-gradient-to-br from-[#ff5b1f]/20 to-[#ff5b1f]/5 flex items-center justify-center text-[#ff5b1f] border border-border overflow-hidden">
...
export default function LiveStats() {
  ...
  return (
    <section data-testid="live-stats-section" ref={ref} className="relative z-10 py-20 border-b border-border">
