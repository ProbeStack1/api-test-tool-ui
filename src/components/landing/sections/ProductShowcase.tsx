...
const SLIDES: Slide[] = [
  {
    ...
    num: "01",
    title: "API Dashboard",
    desc: "Cross-workspace observability — live RPS, p95 latency, OWASP findings, open bugs. Every microservice on one pane.",
  ...
  },
  {
    ...
    desc: "5-level resolution: Global → Workspace → Collection → Env → Local. Secrets masked. Audit-logged.",
