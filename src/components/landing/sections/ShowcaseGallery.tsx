...
import dashboard from '../../../assets/landingpage/dashboard.png';
import collection from '../../../assets/landingpage/collection.png';
import mcp from '../../../assets/landingpage/mcp.png';
import apihub from '../../../assets/landingpage/apihub.png';
import ai from '../../../assets/landingpage/ai.png';
import variable from '../../../assets/landingpage/variable.png';

const showcaseItems = [
  { id: 1, title: 'API Dashboard', image: dashboard, span: 'col-span-2 row-span-2' },
  { id: 2, title: 'Request Runner', image: collection, span: 'col-span-1 row-span-1' },
  { id: 3, title: 'Mcp Stdio', image: mcp, span: 'col-span-1 row-span-1' },
  { id: 4, title: 'API Hub', image: apihub, span: 'col-span-1 row-span-1' },
  { id: 5, title: 'AI Assistant', image: ai, span: 'col-span-1 row-span-1' },
  { id: 6, title: 'Variable Manager', image: variable, span: 'col-span-2 row-span-1' },
];
...
function GalleryItem({ item, isVisible, index, onExpand }) {
  ...
  return (
    <div
      ...
      className={`${item.span} relative group rounded-2xl overflow-hidden landing-card-bg border border-border hover:border-[#ff5b1f]/40 cursor-pointer transition-all duration-500 ${isVisible ? 'animate-slide-in-bottom' : 'opacity-0 translate-y-8'}`}
...
export default function ShowcaseGallery() {
  ...
  return (
    <section data-testid="showcase-section" ref={ref} className="relative z-10 py-20 border-b border-border">
      ...
      {expanded && (
        ...
        >
          ...
          <div className="max-w-8xl max-h-[80vh] rounded-2xl overflow-hidden border border-dark-600 shadow-2xl animate-scale-in" onClick={(e) => e.stopPropagation()}>
            <img
              src={expanded.image}
              alt={expanded.title}
