...
const useCases = [
  {
    ...
    // image: 'https://png.pngtree.com/background/20240507/original/pngtree-digital-retailing-illustration-laptop-keyboard-with-shopping-basket-and-e-commerce-picture-image_8835213.jpg',
    accent: '#ff5b1f',
  },
  {
    icon: Landmark,
