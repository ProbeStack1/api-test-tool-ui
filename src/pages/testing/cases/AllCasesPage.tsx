          ...
          {specQ.data && (
            <span className="ml-2 flex items-center gap-2">
              ...
              <Button
                ...
                onClick={() => {
                  openSpec(specQ.data!.testSpecId);
                  const next = new URLSearchParams();
                  next.set("section", "specs");
                  next.set("specId", specQ.data!.testSpecId);
                  next.delete("runId");
          ...
          >
            <div className="w-full max-w-md rounded-xl border border-dashed border-border bg-surface/40 p-10 text-center">
              ...
              <p className="mt-1 text-xs text-text-muted">
                Create a spec under <strong>Specs</strong> first — generated
